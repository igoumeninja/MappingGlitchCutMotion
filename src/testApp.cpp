...
void testApp::update(){
    ...
    ofFill();
    ofSetHexColor(0xFFFFFF);
    image[randID_1].draw(0,0,1024/2, 768/2 );
    image[randID_2].draw(1024/2, 0, 1024/2, 768/2);
    image[randID_3].draw(0, 768/2, 1024/2, 768/2);
    image[randID_4].draw(1024/2, 768/2, 1024/2, 768/2);
